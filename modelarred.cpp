...
ModelarRed::ModelarRed()
{

}

void ModelarRed::IngresoManualRouters()
{
...
void ModelarRed::borrarConexiones()
{
    int longitud=NomConexRuter.size();
    string datoPop;
...
void ModelarRed::cambioValorConex()
{
    string conexion;
    int valorCam=0;
    int longitud=NomConexRuter.size();
...
void ModelarRed::mostrarCamino(char inicio, string destino)
{
...
vector<int> ModelarRed::getValConexRuter() const
{
    return valConexRuter;
}

void ModelarRed::setValConexRuter(const vector<int> &value)
{
    valConexRuter = value;
}

vector<string> ModelarRed::getNomConexRuter() const
{
    return NomConexRuter;
}

void ModelarRed::setNomConexRuter(const vector<string> &value)
{
    NomConexRuter = value;
}

map<char, vector<string> > ModelarRed::getRouters() const
{
    return routers;
}

void ModelarRed::setRouters(const map<char, vector<string> > &value)
{
    routers = value;
}
